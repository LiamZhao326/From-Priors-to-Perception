...
* **Core Principle:**
Violation of "Conservation of Identity and Intrinsic Properties." Objects must maintain their fundamental characteristics (such as form, species, and quantity) unless subjected to a realistic, transformative physical process.

* **Specific Fallacy Type: Identity Violation**
* **Definition:** An object's identity, morphology, species, or quantity undergoes a sudden, physically impossible mutation without any corresponding causal interaction.
* **Typical Scenarios:**
    1.  **Spontaneous Multiplication (Quantity Mutation):** A single object spontaneously splits or duplicates into multiple distinct objects without a realistic physical mechanism (e.g., a single ball drops to the ground and immediately becomes two identical balls upon impact).
    2.  **Spontaneous Transformation (Morphology/Species Mutation):** An object seamlessly and impossibly transforms into a completely different object or species without external intervention (e.g., a live quail suddenly morphs into a rooster in plain sight).
...
*   **Task:** Review Step 1's description and the user-provided `Category Definition`. Analyze the video content to determine the most suitable physics fallacy implementation, referencing the definition's **"Typical Scenarios"** as a guiding framework. 
    1. **Select** the most appropriate Typical Scenario(e.g., "Spontaneous Multiplication (Quantity Mutation)"). 
...
*   **Principle for [AI_Generation]:**
    ...
    *   *Examples:* Spontaneous Object Multiplication, Morphological/Species Transformation.
...

{
  ...
  "selected_typical_scenario": "String. The exact title of the chosen scenario, e.g., 'Spontaneous Multiplication (Quantity Mutation)'.",
