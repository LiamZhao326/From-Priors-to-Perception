...
*   **Principle for [AI_Generation]:**
    ...
    *   *Examples:* Morphing (Shape change), Material Change (Melting/Soft body), Trajectory Deviation (Physically inconsistent motion), Causal Rewrite (No splash/New Texture).
